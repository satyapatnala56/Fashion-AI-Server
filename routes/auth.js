...
router.post('/signup', [body('name')
    ...
    .not()
    .isEmpty()
    .withMessage('Enter a non-empty name'), body('email')
    .trim()
    .isEmail()
    ...
    .trim()
    .isStrongPassword()
    .withMessage('Password must contain at least 8 characters with at least 1 uppercase, 1 lowercase, 1 number and 1 symbol'),
